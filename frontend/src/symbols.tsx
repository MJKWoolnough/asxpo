...
const addSymbol = (S: () => Element) => ({title: t, ...rest}: PropsObject) => amendNode(<S />, rest, t ? <svg:title>{t}</svg:title> : <></>);

export const Add = addSymbol(() => <svg viewBox="0 0 24 20"><path d="M1,4 h22 v15 h-22 Z m2,0 l3,-3 h5 l3,3 m3,2 v12 m-6,-6 h12" style="stroke: currentColor" fill="none" stroke-linejoin="round" /></svg>),
