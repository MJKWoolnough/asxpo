...
const addSymbol = (params: PropsObject, S: () => SVGElement) => ({title: t, ...rest}: PropsObject) => amendNode(<svg {...params} {...rest}>
	{t ? <title>{t}</title> : <></>}
	<S />
</svg>);

export const Add = addSymbol({"viewBox": "0 0 24 20"}, () => <>
	...
	Remove = addSymbol({"viewBox": "0 0 32 34"}, () => <path d="M10,5 v-3 q0,-1 1,-1 h10 q1,0 1,1 v3 m8,0 h-28 q-1,0 -1,1 v2 q0,1 1,1 h28 q1,0 1,-1 v-2 q0,-1 -1,-1 m-2,4 v22 q0,2 -2,2 h-20 q-2,0 -2,-2 v-22 m2,3 v18 q0,1 1,1 h3 q1,0 1,-1 v-18 q0,-1 -1,-1 h-3 q-1,0 -1,1 m7.5,0 v18 q0,1 1,1 h3 q1,0 1,-1 v-18 q0,-1 -1,-1 h-3 q-1,0 -1,1 m7.5,0 v18 q0,1 1,1 h3 q1,0 1,-1 v-18 q0,-1 -1,-1 h-3 q-1,0 -1,1" style="stroke: currentColor" fill="none" /> as SVGElement),
	Edit = addSymbol({"viewBox": "0 0 70 70", "fill": "none", "style": "stroke: currentColor"}, () => <>
